  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900">
          ...
          >
            {filteredProducts.map((product) => (
              <Card 
                ...
                onClick={() => router.push(`/dashboard/projects/${product.id}`)}
              >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[650px]"> {/* Increased width further */}
                ...
                <div className="col-span-3">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      placeholder="Type a single keyword and click 'Add'"
                  ...
                  <p className="text-sm text-gray-500 mt-2">Add up to 5 keywords, one at a time. Click 'Add' after each keyword.</p>
