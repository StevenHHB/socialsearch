...
import { FiBarChart } from 'react-icons/fi'; // Or the appropriate icon library
...
import { FaXTwitter } from 'react-icons/fa6'; // Import the new X (Twitter) icon
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 mb-12">
              <div className="flex items-center space-x-3">
                <div className="bg-[#fff0e5] rounded-full p-1">
                  <Search className="h-5 w-5 text-primary" />
                </div>
                <span className="text-lg text-gray-700">Get into relevant Reddit posts ranking high on Google</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-[#fff0e5] rounded-full p-1">
                  <MessageSquare className="h-5 w-5 text-primary" />
                </div>
                <span className="text-lg text-gray-700">Use AI-guided replies to naturally promote your product</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-[#fff0e5] rounded-full p-1">
                  <TrendingUp className="h-5 w-5 text-primary" />
                </div>
                <span className="text-lg text-gray-700">Monitor your brand and competitors 24/7</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-[#fff0e5] rounded-full p-1">
                  <Zap className="h-5 w-5 text-primary" />
                </div>
                <span className="text-lg text-gray-700">Boost your visibility in AI-driven search results</span>
              </div>
            </div>

            <Link href="/sign-up">
              <Button size="lg" className="mb-8 bg-[#ff6f2c] text-white hover:bg-[#ff6f2c]/90">
                Get Customers From Reddit, X, and LinkedIn Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <div className="bg-white rounded-xl shadow-lg p-6 mb-12">
              <div className="flex items-start space-x-4">
                <img src="/images/headshot.jpg?height=48&width=48" alt="User avatar" className="rounded-full w-12 h-12" />
            ...
            <div className="relative">
              <img
                src="/images/screenshot.svg?height=500&width=1000"
                alt="SocialTargeter Interface"
                className="rounded-lg shadow-2xl w-full"
              />
              <div className="absolute top-4 right-4 bg-white rounded-md shadow-md p-3">
                <img src="/images/ai_logo.png?height=40&width=40" alt="SocialTargeter logo" className="w-10 h-10 mb-2" />
        ...
        <section id="how-it-works" className="w-full py-12 md:py-20">
                ...
                <CardContent className="pt-12 pb-8">
                  <div className="mb-4 h-40 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex flex-col items-center justify-center space-y-2">
                    <div className="bg-white p-2 rounded-md shadow-md w-3/4">
                      <span className="text-gray-600">socialtargeter1.com</span>
                    </div>
                    <div className="bg-white p-2 rounded-md shadow-md w-3/4">
                      <span className="text-gray-600">socialtargeter2.com</span>
                    </div>
                    <div className="bg-white p-2 rounded-md shadow-md w-3/4">
                      <span className="text-gray-600">socialtargeter3.com</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-lg p-4 h-40">
                    <div className="bg-white rounded-lg p-3 space-y-3 h-full overflow-y-auto">
                      ...
                      <div className="border border-gray-200 rounded p-2">
                        ...
                        <h4 className="text-sm font-medium mb-1">Good alternative to Socialtargeter1.com?</h4>
            ...
            <div className="flex justify-center mt-8">
              <div className="flex items-center space-x-2 bg-white rounded-full px-4 py-2 shadow-md">
                <div className="flex -space-x-2">
                  <img src="/images/avatar1.svg?height=32&width=32" alt="User 1" className="w-8 h-8 rounded-full border-2 border-white" />
                  <img src="/images/avatar2.svg?height=32&width=32" alt="User 2" className="w-8 h-8 rounded-full border-2 border-white" />
                  <img src="/images/avatar3.svg?height=32&width=32" alt="User 3" className="w-8 h-8 rounded-full border-2 border-white" />
                  <img src="/images/avatar4.svg?height=32&width=32" alt="User 4" className="w-8 h-8 rounded-full border-2 border-white" />
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 lg:grid-cols-2">
              ...
              <div className="relative">
                <img
                  src="/images/reddit_traffic.png?height=600&width=800"
            ...
            <div className="flex justify-center mt-12">
              <div className="flex items-center space-x-4 bg-white rounded-full px-6 py-3 shadow-md">
                <img src="/images/reddit_logo.svg?height=48&width=48" alt="Reddit logo" className="w-12 h-12" />
                <span className="text-lg font-medium">+</span>
                <img src="/images/x_logo.svg?height=24&width=24" alt="X logo" className="w-6 h-6" />
                <ArrowRight className="h-6 w-6 text-primary" />
                <div className="flex items-center space-x-2">
                  <img src="/images/google_logo.png?height=48&width=48" alt="Google logo" className="w-12 h-12" />
                  <img src="/images/chatgpt_logo.svg?height=48&width=48" alt="ChatGPT logo" className="w-12 h-12" />
                  <img src="/images/perplexity_logo.svg?height=48&width=48" alt="Perplexity logo" className="w-12 h-12" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-white">
          <div className="container px-4 md:px-6">
            ...
            {/* Add this div to wrap the new content */}
